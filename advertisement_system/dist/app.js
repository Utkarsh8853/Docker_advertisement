...
dotenv.config();
const port = envConfig_1.serverConfig.PORT;
const hostname = envConfig_1.serverConfig.HOST;
console.log(`host`, envConfig_1.serverConfig.HOST);
console.log('////', envConfig_1.serverConfig.PORT);
